 ...
 *
 * @param <E>
 *            the data conatined by the node
 */
...
public class MyLinkedList<E> implements List211<E>, Iterable<E> {
	...
	/**
	 * @param finished:
	 *            used to keep bubbleSort from running on a sorted list
	 * @param head:
	 *            points to the beginning of the linkedList
	 * @param tail:
	 *            points to the end of the linkedList
	 * @param temp:
	 *            used to traverse the linkedList
	 * @param tempData:
	 *            temporarily stores data from the DLinkedNode data variables
	 * @param placeHolder:
	 *            used in sorts
	 * @param size:
	 *            the length of the linkedList
	 * @param dataArray:
	 *            holds an array of the data variables from the linkedList nodes
	 */
	 ...
	 *            data variable
	 * 
	 *            creates a node that holds an object and can point to the next
	 ...
	 * 
	 * @param cycleTo:
	 *            cycles from the end of the list to the position indicated by
	 *            cycleTo
	 */
	...
	/**
	 * inserts data values in dataArray into the data variables in the
	 * DLinkedNodes this is done so the previously made array sorting methods
	 * could be implemented with few changes
	 */
	...
	/**
	 * returns the index of the object obj if obj is not in the linkedList then
	 * it returns -1
	 */
	...
	/**
	 * used to make an array of data from the data in the DlinkedNodes this is
	 * done so the previously made array sorting methods could be implemented
	 * with few changes
	 */
	@SuppressWarnings("unchecked")
	private E[] makeArray() {
	...
	/**
	 * removes a DLinkedNode from the list at index by changing the previous and
	 * next pointers of the nodes that point to it
	 */
	@Override
