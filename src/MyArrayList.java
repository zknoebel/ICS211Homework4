 ...
 *
 * @param <E>
 *            allows for arrays of any type to be made
 */
public class MyArrayList<E> implements List211<E>, Iterable<E> {
	...
	private class ArrayListIterator implements ListIterator<E> {
		...
		private Integer lastReturnedPosition = null;
	...
	// checks to see if a specific object is in the array and if it is, return
	// the index that it is located at
	...
	// Takes in a comparator for comparing a specific class and then uses a
	...
	// Takes in a comparator used to compare a specific class and uses an
	...
	// removes an object by rewriting over it and shifting all elements with
	// greater indices to the left
	@Override
	...
	// takes in a comparator to compare a certain class and then uses a
