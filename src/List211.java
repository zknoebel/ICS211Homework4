...
public interface List211<E> {
	 ...
	 *
	 * Existing elements greater than and equal to the specified index move by
	 * one position. In other words, if an element is added to position "i", the
	 * new element will be at position "i", the existing element previously at
	 * "i" becomes "i+1", the element at "i+1" becomes "i+2", etc. If "index" is
	 * greater than the value returned by the size() method, an
	 * IndexOutOfBoundsException is thrown.
	 *
	 * @param index
	 *            Position in array list to add new element.
	 * @param element
	 *            New element to add.
	 */
	 ...
	 *
	 * If "index" does not refer to a valid element, an
	 * IndexOutOfBoundsException is thrown.
	 *
	 * @param index
	...
	/**
	 * Removes the element at the specified index and reduces the size of the
	 * array list by one.
	 *
	 ...
	 *
	 * @param index
	 *            Position in array of element to remove.
	 */
	E remove(int index);
	...
	/**
	 * Returns the index at which the given object is stored. If it is not in
	 * the list, then returns -1.
	 */
